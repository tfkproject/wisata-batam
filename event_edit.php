            ...
            <div class="tile-body">
              <form action="event_edit_proses.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <input class="form-control" type="date" name="tanggal" value="<?php echo $row['tanggal'];?>" placeholder="Tanggal">
                  <input class="form-control" type="hidden" name="id_event" value="<?php echo $row['id_event'];?>">
                </div>
                <div class="form-group">
                  <label class="control-label">Event</label>
                  <textarea class="form-control" type="text" name="event" placeholder="Event" ><?php echo $row['event'];?></textarea>
                </div>
