...
public class ObjekWisataCariActivity extends AppCompatActivity {
    ...
    private static String url = "http://203.153.21.11/app/wisata-batam/api/wisata_list_cari.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //isi disini
        new getData(keyword).execute();

        adapter = new ObjekWisataAdapter(ObjekWisataCariActivity.this, itemList);
    ...
    private class getData extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ObjekWisataCariActivity.this);
